                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                        ...
                                        <th className="w-1/4 truncate ... px-4 py-3">Harga Beli</th>
                                        <th className="w-1/4 truncate ... px-4 py-3">Jumlah</th>
                                        <th className="w-1/4 truncate ... px-4 py-3">Harga Jual</th>
                                    ...
                                    {loading ? (
                                        ...
                                        dataStok.map((stok) => (
                                            <tr key={stok} className="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">1</td>
