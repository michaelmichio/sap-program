                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                        ...
                                        <th className="w-1/6 truncate ... px-4 py-3">Id</th>
                                        <th className="w-1/4 truncate ... px-4 py-3">Nama</th>
                                        <th className="w-1/4 truncate ... px-4 py-3">Alamat</th>
                                        <th className="w-1/4 truncate ... px-4 py-3">Email</th>
                                        <th className="w-1/4 truncate ... px-4 py-3">No. Telp</th>
                                ...
                                <tbody className="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    {loading ? (
                                        ...
                                        dataCustomer.map((customer) => (
                                            <tr key={customer} className="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                <td className="w-1/12 truncate ... px-4 py-3 text-sm">1</td>
                                                <td className="w-1/6 truncate ... px-4 py-3 text-sm">{customer.id}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{customer.name}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{customer.address}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{customer.email}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-xs">{customer.phone}</td>
