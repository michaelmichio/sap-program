                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                        ...
                                        <th className="w-1/4 truncate ... px-4 py-3">Supplier</th>
                                    ...
                                    {loading ? (
                                        ...
                                        dataPembelian.map((pembelian) => (
                                            <tr key={pembelian} className="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                                ...
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{pembelian.nomor_invoice}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{pembelian.tanggal}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{pembelian.pemasok}</td>
                                                <td className="w-1/4 truncate ... px-4 py-3 text-sm">{pembelian.total_biaya}</td>
